...
read_verilog -sv [file join $root syn rtl ti32_lp1_fs4_dsm_ooc.sv]
set_param general.maxThreads 1
set_param synth.maxThreads 1
synth_design -top ti32_lp1_fs4_dsm_ooc -part $part -mode out_of_context -flatten_hierarchy none -directive AreaOptimized_high
...
puts $fp "$part,ti32_lp1_fs4_dsm_ooc,[format %.2f $target_mhz],$status,[format %.3f $wns],[format %.3f $whs],[format %.2f $fmax]"
close $fp
puts "TI32_LP1_FS4_OOC_STATUS=$status"
