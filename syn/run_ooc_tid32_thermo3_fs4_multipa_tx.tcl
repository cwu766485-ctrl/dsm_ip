...
read_verilog -sv [file join $root rtl tx_bandpass_if tid32_thermo3_fs4_multipa_tx.sv]
read_verilog -sv [file join $root syn rtl tid32_thermo3_fs4_multipa_tx_ooc.sv]
set_param general.maxThreads 1
set_param synth.maxThreads 1
synth_design -top tid32_thermo3_fs4_multipa_tx_ooc -part $part -mode out_of_context -flatten_hierarchy none -directive AreaOptimized_high
...
puts $fp "$part,tid32_thermo3_fs4_multipa_tx_ooc,[format %.2f $target_mhz],$status,[format %.3f $wns],[format %.3f $whs],[format %.2f $fmax]"
close $fp
puts "TID32_THERMO3_FS4_MULTIPA_TX_OOC_STATUS=$status"
