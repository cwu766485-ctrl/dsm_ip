...
read_verilog -sv [file join $root syn rtl ti64_lp1_fs4_gt_tx_ooc.sv]
set_param general.maxThreads 1
set_param synth.maxThreads 1
synth_design -top ti64_lp1_fs4_gt_tx_ooc -part $part -mode out_of_context -flatten_hierarchy none -directive AreaOptimized_high
write_checkpoint -force [file join $out_dir synthesized.dcp]
create_clock -name clk -period $period_ns [get_ports clk]
# This OOC block has no board-specific source or GT hard-IP timing model.
# Do not invent zero-delay I/O constraints: they create an artificial primary
# input hold path. The reported result is fabric register-to-register timing.
# Real input/output delays, GT clocks, reset treatment and CDC constraints are
# an implementation-level responsibility of the generated GT Wizard/top.
...
puts $fp "$part,ti64_lp1_fs4_gt_tx_ooc,[format %.2f $target_mhz],$status,[format %.3f $wns],[format %.3f $whs],[format %.2f $fmax]"
close $fp
puts "TI64_LP1_FS4_GT_TX_OOC_STATUS=$status"
