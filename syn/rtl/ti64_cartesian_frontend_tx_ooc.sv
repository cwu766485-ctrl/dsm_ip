...
module ti64_cartesian_frontend_tx_ooc (
  input  wire logic         clk,
  input  wire logic         rst_n,
  input  wire logic         in_valid,
  output wire logic         in_ready,
  input  wire logic signed [1023:0] in_i_vec,
  input  wire logic signed [1023:0] in_q_vec,
  ...
  ti64_cartesian_frontend_tx #(.W(16), .ACC_W(28), .SATURATE(1'b1)) u_dut (
