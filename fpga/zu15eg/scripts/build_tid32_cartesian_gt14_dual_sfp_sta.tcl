# Route the real TID32 payload through the dual-SFP GTH without ILA.
# This is the timing-signoff target; the ILA-bearing sibling remains a
# separate bring-up build and must never block payload STA.
...
create_project tid32_cartesian_gt14_dual_sfp_sta $build_dir -part xczu15eg-ffvb1156-2-i -force
...
set_property generic {USE_ILA=0} [current_fileset]
...
write_bitstream -force [file join $out_dir tid32_cartesian_gt14_dual_sfp_sta.bit]
puts "TID32_CARTESIAN_GT14_DUAL_SFP_STA_BUILT=$out_dir"
