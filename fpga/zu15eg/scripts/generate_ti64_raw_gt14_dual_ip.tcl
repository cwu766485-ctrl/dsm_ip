# Generate, outside the source tree, a board-specific dual-channel raw-GTH
# serializer. X1Y12 and X1Y13 are the adjacent SFP0/SFP1 channels in quad 230.
# Usage: vivado -mode batch -source generate_ti64_raw_gt14_dual_ip.tcl -tclargs <out_dir>
if {[llength $argv] != 1} { error "usage: <out_dir>" }
set out_dir [file normalize [lindex $argv 0]]
file mkdir $out_dir
create_project ti64_raw_gt14_dual $out_dir -part xczu15eg-ffvb1156-2-i -force
set_property target_language Verilog [current_project]
create_ip -name gtwizard_ultrascale -vendor xilinx.com -library ip -module_name ti64_raw_gt14_dual
set ip [get_ips ti64_raw_gt14_dual]
set_property -dict [list \
  CONFIG.CHANNEL_ENABLE {X1Y12 X1Y13} \
...
puts "TI64_RAW_GT14_DUAL_IP_GENERATED=$out_dir"
