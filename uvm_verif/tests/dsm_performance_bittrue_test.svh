class dsm_performance_bittrue_test extends dsm_base_test;
  `uvm_component_utils(dsm_performance_bittrue_test)
  ...
  task run_phase(uvm_phase phase);
    dsm_performance_virtual_sequence seq;
    int unsigned drain_cycles;
    seq = dsm_performance_virtual_sequence::type_id::create("seq");
