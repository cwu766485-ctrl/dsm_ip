...
tests="dsm_axi_protocol_test,dsm_control_stress_test,dsm_memory_dpd_commit_stress_test,dsm_axis_coverage_test,dsm_system_closure_test,dsm_negative_control_test"
