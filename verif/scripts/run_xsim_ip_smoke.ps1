...
$rtlFiles = @(
  "$repo\rtl\dsm\dsm_core.sv",
  "$repo\rtl\dsm\dsm_core_dsm2.sv",
  "$repo\rtl\dsm\dsm_core_ef1.sv",
  "$repo\rtl\dsm\dsm_core_ef2.sv",
  "$repo\rtl\dsm\dsm_core_mash11.sv",
  "$repo\rtl\dsm\dsm_core_mash111.sv",
  "$repo\rtl\dsm\dsm_core_mash22.sv",
