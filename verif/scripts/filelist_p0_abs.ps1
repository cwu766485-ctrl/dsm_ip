...
$lines = @(
  ...
  "$RepoRoot\rtl\dsm\dsm_core.sv",
  "$RepoRoot\rtl\dsm\dsm_core_dsm2.sv",
  "$RepoRoot\rtl\dsm\dsm_core_ef1.sv",
  "$RepoRoot\rtl\dsm\dsm_core_ef2.sv",
  "$RepoRoot\rtl\dsm\dsm_core_mash11.sv",
  "$RepoRoot\rtl\dsm\dsm_core_mash111.sv",
  "$RepoRoot\rtl\dsm\dsm_core_mash22.sv",
