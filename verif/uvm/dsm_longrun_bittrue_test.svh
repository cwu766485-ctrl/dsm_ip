class dsm_longrun_bittrue_test extends dsm_base_test;
  `uvm_component_utils(dsm_longrun_bittrue_test)

  localparam int unsigned LONGRUN_INPUT_COUNT = 4096;
  ...
  function void build_phase(uvm_phase phase);
    ...
    cfg.fullchain_vector_set = "longrun_prbs";
    cfg.expected_rf_count = LONGRUN_INPUT_COUNT * DSM_SKU_INTERP_RATIO;
    cfg.post_sequence_cycles = 64;
    cfg.drain_timeout_cycles = 1_000_000;
  endfunction

  task run_phase(uvm_phase phase);
    dsm_longrun_bittrue_virtual_sequence seq;
    int unsigned drain_cycles;
    phase.raise_objection(this);
    seq = dsm_longrun_bittrue_virtual_sequence::type_id::create("seq");
