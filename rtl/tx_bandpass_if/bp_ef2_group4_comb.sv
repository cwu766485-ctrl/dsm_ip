// Four-sample combinational group for the scheduled temporal64 candidate.
`timescale 1ns/1ps
`default_nettype none

module bp_ef2_group4_comb #(
  ...
  logic signed [ACC_W-1:0] e1_work [0:3];
  logic signed [ACC_W-1:0] e2_work [0:3];
  logic signed [ACC_W-1:0] y_work [0:3];
