...
// P0 wrapper: EFDSM2 (EF2)
module p0_top_ef2 #(
  parameter integer W = 16,
  parameter integer ADDR_W = 16,
  parameter integer DEPTH = 65536,
  parameter integer ACC_W = 28,
  parameter integer IN_SHIFT = 0,
  parameter         DSM_SATURATE = 1'b1,
  parameter integer COEFF_W = 8,
  parameter integer EF_B1_NUM = 2,
  parameter integer EF_B2_NUM = -1,
  parameter integer EF_COEFF_SHIFT = 0,
  ...
  wire signed [ACC_W-1:0] v_i_state;
  wire signed [ACC_W-1:0] v_q_state;
